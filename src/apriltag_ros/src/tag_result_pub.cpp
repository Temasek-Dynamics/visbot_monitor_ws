...
int main(int argc, char **argv)
{
  ...
  topic_drone_detect = "/drone_detect";
  ...
  else
  {
    ...
    topic_robot_odom = "/mavros/local_position/odom";
    topic_uav_state = "/mavros/state";
    topic_uav_mode = "/mavros/set_mode";
    topic_wp_finished = "/waypoint_finished";//ego finished waypoint flag
  }
  ...
  for (int id = 0; id < drone_num; ++id) {
    ...
    // subscribe to other drones' detection results
  ...
  // publish the land goal to ego planner
  ...
  // visulization of the tag result and uav model
