...
{
    m_image_boundary_color.r = 0.0;
    m_image_boundary_color.g = 1.0;
    m_image_boundary_color.b = 1.0;
    m_image_boundary_color.a = 1.0;
    m_optical_center_connector_color.r = 0.0;
    m_optical_center_connector_color.g = 1.0;
    m_optical_center_connector_color.b = 1.0;
    m_optical_center_connector_color.a = 1.0;
    m_scale = 1.0;
    m_line_width =0.06;
