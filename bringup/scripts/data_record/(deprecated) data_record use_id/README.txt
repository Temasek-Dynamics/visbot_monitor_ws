This deprecated directory includes the scripts that were used to record data from the robots and transfer the recorded data to the gcs.
...
The recording scripts on onboard computers are now relocated in ~/ros_ws/src/visbot_scripts, instead of ~/UserData/scripts/data_record.
